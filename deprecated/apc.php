...
if (! function_exists('\\Safe\\apc_cache_info')) {
    /**
...
if (! function_exists('\\Safe\\apc_cas')) {
    /**
...
if (! function_exists('\\Safe\\apc_compile_file')) {
    /**
...
if (! function_exists('\\Safe\\apc_dec')) {
    /**
...
if (! function_exists('\\Safe\\apc_define_constants')) {
    /**
...
if (! function_exists('\\Safe\\apc_delete_file')) {
    /**
...
if (! function_exists('\\Safe\\apc_delete')) {
    /**
...
if (! function_exists('\\Safe\\apc_inc')) {
    /**
...
if (! function_exists('\\Safe\\apc_load_constants')) {
    /**
...
if (! function_exists('\\Safe\\apc_sma_info')) {
    /**
