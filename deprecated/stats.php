...
if (! function_exists('\\Safe\\stats_covariance')) {
    /**
...
if (! function_exists('\\Safe\\stats_standard_deviation')) {
    /**
...
if (! function_exists('\\Safe\\stats_stat_correlation')) {
    /**
...
if (! function_exists('\\Safe\\stats_stat_innerproduct')) {
    /**
...
if (! function_exists('\\Safe\\stats_variance')) {
    /**
