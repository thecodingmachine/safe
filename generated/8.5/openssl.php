 ...
 * output_filename.
 *
 * @param resource|string $csr See CSR parameters for a list of valid values.
 ...
 *
 * @param resource|string $csr A CSR previously generated by openssl_csr_new.
 ...
 * @param array|resource|string $private_key The private key used for decrypting encrypted_key.
 ...
 *
 * @param resource|string $certificate See Key/Certificate parameters for a list of valid values.
 * @param string $output_filename Path to the output file.
 ...
 * @param resource|string $certificate The X.509 certificate used to digitally sign input_filename.
 * See Key/Certificate parameters for a list of valid values.
 ...
 *
 */
function openssl_pkey_get_private(string $private_key, ?string $passphrase = null): \OpenSSLAsymmetricKey
{
    error_clear_last();
    if ($passphrase !== null) {
 ...
 * @param array|resource|string $private_key private_key must be the private key that corresponds
 ...
 * @param string $data
 * @param string|null $decrypted_data
 * @param resource|string $public_key public_key must be the public key that corresponds
 ...
 * it.
 *
 * @param resource|string $certificate X509 certificate. See Key/Certificate parameters for a list of valid values.
 * @return \OpenSSLCertificate Returns an OpenSSLCertificate on success.
 * @throws OpensslException
 *
 */
