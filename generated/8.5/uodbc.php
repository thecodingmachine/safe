 ...
 *
 * @param resource $statement &odbc.result.object;.
 ...
 * @return resource &odbc.result.object-return; if the SQL command was executed
 * successfully.
 * @throws UodbcException
 *
 */
 ...
 *
 * @param resource $statement &odbc.result.object; from odbc_prepare.
 ...
 * @return resource &odbc.result.object-return; if the SQL command was prepared
 * successfully.
 * @throws UodbcException
 *
 */
 ...
 * % to match zero or more characters,
 * and _ to match a single character.
 * @return resource &odbc.result.object-return; containing the information.
 *
