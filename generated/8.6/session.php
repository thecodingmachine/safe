...
/**
 * By default, PHP uses session.gc_probability
 ...
 * UNIX-like systems to run a script that calls session_gc.
 *
 * @return int session_gc returns the number of deleted session
 * entries on success.
 * @throws SessionException
 *
 */
