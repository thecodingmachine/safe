 ...
 * @throws Exceptions\FannException
 * 
 */
function fann_copy($ann)
{
    error_clear_last();
    $result = \fann_copy($ann);
    if ($result === FALSE) {
        throw Exceptions\FannException::createFromPhpError();
    }
    return $result;
}
...
{
    error_clear_last();
    $result = \fann_create_shortcut_array($num_layers, $layers);
    if ($result === FALSE) {
        throw Exceptions\FannException::createFromPhpError();
    }
    return $result;
 ...
 * @param int $params Number of neurons in other layers.
 * @return reference Returns a neural network resource on success, .
 * @throws Exceptions\FannException
 * 
 */
function fann_create_shortcut(int $num_layers, int $num_neurons1, int $num_neurons2, int  ...$params)
{
    error_clear_last();
    if ($params !== null) {
        $result = \fann_create_shortcut($num_layers, $num_neurons1, $num_neurons2, $params);
    }else {
        $result = \fann_create_shortcut($num_layers, $num_neurons1, $num_neurons2);
    }
    if ($result === FALSE) {
        throw Exceptions\FannException::createFromPhpError();
    }
...
{
    error_clear_last();
    $result = \fann_create_sparse_array($connection_rate, $num_layers, $layers);
    if ($result === FALSE) {
        throw Exceptions\FannException::createFromPhpError();
    }
    return $result;
 ...
 * 
 */
function fann_create_sparse(float $connection_rate, int $num_layers, int $num_neurons1, int $num_neurons2, int  ...$params)
{
    error_clear_last();
    if ($params !== null) {
        $result = \fann_create_sparse($connection_rate, $num_layers, $num_neurons1, $num_neurons2, $params);
    }else {
        $result = \fann_create_sparse($connection_rate, $num_layers, $num_neurons1, $num_neurons2);
    }
    if ($result === FALSE) {
        throw Exceptions\FannException::createFromPhpError();
    }
...
{
    error_clear_last();
    $result = \fann_create_standard_array($num_layers, $layers);
    if ($result === FALSE) {
        throw Exceptions\FannException::createFromPhpError();
    }
    return $result;
 ...
 * 
 */
function fann_create_standard(int $num_layers, int $num_neurons1, int $num_neurons2, int  ...$params)
{
    error_clear_last();
    if ($params !== null) {
        $result = \fann_create_standard($num_layers, $num_neurons1, $num_neurons2, $params);
    }else {
        $result = \fann_create_standard($num_layers, $num_neurons1, $num_neurons2);
    }
    if ($result === FALSE) {
        throw Exceptions\FannException::createFromPhpError();
    }
...
{
    error_clear_last();
    $result = \fann_get_activation_function($ann, $layer, $neuron);
    if ($result === FALSE) {
        throw Exceptions\FannException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \fann_get_activation_steepness($ann, $layer, $neuron);
    if ($result === FALSE) {
        throw Exceptions\FannException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \fann_get_bit_fail_limit($ann);
    if ($result === FALSE) {
        throw Exceptions\FannException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \fann_get_cascade_activation_functions_count($ann);
    if ($result === FALSE) {
        throw Exceptions\FannException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \fann_get_cascade_activation_functions($ann);
    if ($result === FALSE) {
        throw Exceptions\FannException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \fann_get_cascade_activation_steepnesses_count($ann);
    if ($result === FALSE) {
        throw Exceptions\FannException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \fann_get_cascade_activation_steepnesses($ann);
    if ($result === FALSE) {
        throw Exceptions\FannException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \fann_get_cascade_candidate_change_fraction($ann);
    if ($result === FALSE) {
        throw Exceptions\FannException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \fann_get_cascade_candidate_limit($ann);
    if ($result === FALSE) {
        throw Exceptions\FannException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \fann_get_cascade_candidate_stagnation_epochs($ann);
    if ($result === FALSE) {
        throw Exceptions\FannException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \fann_get_cascade_max_cand_epochs($ann);
    if ($result === FALSE) {
        throw Exceptions\FannException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \fann_get_cascade_max_out_epochs($ann);
    if ($result === FALSE) {
        throw Exceptions\FannException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \fann_get_cascade_min_cand_epochs($ann);
    if ($result === FALSE) {
        throw Exceptions\FannException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \fann_get_cascade_min_out_epochs($ann);
    if ($result === FALSE) {
        throw Exceptions\FannException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \fann_get_cascade_num_candidate_groups($ann);
    if ($result === FALSE) {
        throw Exceptions\FannException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \fann_get_cascade_num_candidates($ann);
    if ($result === FALSE) {
        throw Exceptions\FannException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \fann_get_cascade_output_change_fraction($ann);
    if ($result === FALSE) {
        throw Exceptions\FannException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \fann_get_cascade_output_stagnation_epochs($ann);
    if ($result === FALSE) {
        throw Exceptions\FannException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \fann_get_cascade_weight_multiplier($ann);
    if ($result === FALSE) {
        throw Exceptions\FannException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \fann_get_network_type($ann);
    if ($result === FALSE) {
        throw Exceptions\FannException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \fann_get_num_layers($ann);
    if ($result === FALSE) {
        throw Exceptions\FannException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \fann_get_num_output($ann);
    if ($result === FALSE) {
        throw Exceptions\FannException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \fann_get_quickprop_decay($ann);
    if ($result === FALSE) {
        throw Exceptions\FannException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \fann_get_quickprop_mu($ann);
    if ($result === FALSE) {
        throw Exceptions\FannException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \fann_get_rprop_decrease_factor($ann);
    if ($result === FALSE) {
        throw Exceptions\FannException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \fann_get_rprop_delta_max($ann);
    if ($result === FALSE) {
        throw Exceptions\FannException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \fann_get_rprop_delta_min($ann);
    if ($result === FALSE) {
        throw Exceptions\FannException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \fann_get_rprop_delta_zero($ann);
    if ($result === FALSE) {
        throw Exceptions\FannException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \fann_get_rprop_increase_factor($ann);
    if ($result === FALSE) {
        throw Exceptions\FannException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \fann_get_sarprop_step_error_shift($ann);
    if ($result === FALSE) {
        throw Exceptions\FannException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \fann_get_sarprop_step_error_threshold_factor($ann);
    if ($result === FALSE) {
        throw Exceptions\FannException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \fann_get_sarprop_temperature($ann);
    if ($result === FALSE) {
        throw Exceptions\FannException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \fann_get_sarprop_weight_decay_shift($ann);
    if ($result === FALSE) {
        throw Exceptions\FannException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \fann_get_total_connections($ann);
    if ($result === FALSE) {
        throw Exceptions\FannException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \fann_get_total_neurons($ann);
    if ($result === FALSE) {
        throw Exceptions\FannException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \fann_get_train_error_function($ann);
    if ($result === FALSE) {
        throw Exceptions\FannException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \fann_get_train_stop_function($ann);
    if ($result === FALSE) {
        throw Exceptions\FannException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \fann_get_training_algorithm($ann);
    if ($result === FALSE) {
        throw Exceptions\FannException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \fann_length_train_data($data);
    if ($result === FALSE) {
        throw Exceptions\FannException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \fann_merge_train_data($data1, $data2);
    if ($result === FALSE) {
        throw Exceptions\FannException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \fann_num_input_train_data($data);
    if ($result === FALSE) {
        throw Exceptions\FannException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \fann_num_output_train_data($data);
    if ($result === FALSE) {
        throw Exceptions\FannException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \fann_test_data($ann, $data);
    if ($result === FALSE) {
        throw Exceptions\FannException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \fann_test($ann, $input, $desired_output);
    if ($result === FALSE) {
        throw Exceptions\FannException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \fann_train_epoch($ann, $data);
    if ($result === FALSE) {
        throw Exceptions\FannException::createFromPhpError();
    }
    return $result;
