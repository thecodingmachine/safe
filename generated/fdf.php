...
{
    error_clear_last();
    $result = \fdf_add_doc_javascript($fdf_document, $script_name, $script_code);
    if ($result === FALSE) {
        throw Exceptions\FdfException::createFromPhpError();
    }
}
...
{
    error_clear_last();
    $result = \fdf_get_ap($fdf_document, $field, $face, $filename);
    if ($result === FALSE) {
        throw Exceptions\FdfException::createFromPhpError();
    }
}
...
{
    error_clear_last();
    $result = \fdf_open_string($fdf_data);
    if ($result === FALSE) {
        throw Exceptions\FdfException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \fdf_save_string($fdf_document);
    if ($result === FALSE) {
        throw Exceptions\FdfException::createFromPhpError();
    }
    return $result;
...
function fdf_save($fdf_document, string $filename = null): void
{
    error_clear_last();
    if ($filename !== null) {
        $result = \fdf_save($fdf_document, $filename);
    }else {
        $result = \fdf_save($fdf_document);
    }
    if ($result === FALSE) {
        throw Exceptions\FdfException::createFromPhpError();
    }
...
{
    error_clear_last();
    $result = \fdf_set_ap($fdf_document, $field_name, $face, $filename, $page_number);
    if ($result === FALSE) {
        throw Exceptions\FdfException::createFromPhpError();
    }
}
...
{
    error_clear_last();
    $result = \fdf_set_encoding($fdf_document, $encoding);
    if ($result === FALSE) {
        throw Exceptions\FdfException::createFromPhpError();
    }
}
...
function fdf_set_file($fdf_document, string $url, string $target_frame = null): void
{
    ...
    if ($target_frame !== null) {
        $result = \fdf_set_file($fdf_document, $url, $target_frame);
    }else {
        $result = \fdf_set_file($fdf_document, $url);
    }
    if ($result === FALSE) {
        throw Exceptions\FdfException::createFromPhpError();
    }
...
{
    error_clear_last();
    $result = \fdf_set_flags($fdf_document, $fieldname, $whichFlags, $newFlags);
    if ($result === FALSE) {
        throw Exceptions\FdfException::createFromPhpError();
    }
}
...
{
    error_clear_last();
    $result = \fdf_set_javascript_action($fdf_document, $fieldname, $trigger, $script);
    if ($result === FALSE) {
        throw Exceptions\FdfException::createFromPhpError();
    }
}
...
{
    error_clear_last();
    $result = \fdf_set_opt($fdf_document, $fieldname, $element, $str1, $str2);
    if ($result === FALSE) {
        throw Exceptions\FdfException::createFromPhpError();
    }
}
...
{
    error_clear_last();
    $result = \fdf_set_status($fdf_document, $status);
    if ($result === FALSE) {
        throw Exceptions\FdfException::createFromPhpError();
    }
}
...
{
    error_clear_last();
    $result = \fdf_set_submit_form_action($fdf_document, $fieldname, $trigger, $script, $flags);
    if ($result === FALSE) {
        throw Exceptions\FdfException::createFromPhpError();
    }
}
...
{
    error_clear_last();
    $result = \fdf_set_target_frame($fdf_document, $frame_name);
    if ($result === FALSE) {
        throw Exceptions\FdfException::createFromPhpError();
    }
}
...
function fdf_set_value($fdf_document, string $fieldname, $value, int $isName = null): void
{
    error_clear_last();
    if ($isName !== null) {
        $result = \fdf_set_value($fdf_document, $fieldname, $value, $isName);
    }else {
        $result = \fdf_set_value($fdf_document, $fieldname, $value);
    }
    if ($result === FALSE) {
        throw Exceptions\FdfException::createFromPhpError();
    }
...
{
    error_clear_last();
    $result = \fdf_set_version($fdf_document, $version);
    if ($result === FALSE) {
        throw Exceptions\FdfException::createFromPhpError();
    }
}
