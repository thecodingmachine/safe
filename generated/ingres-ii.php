...
if (! function_exists('\\Safe\\ingres_autocommit')) {
    /**
...
if (! function_exists('\\Safe\\ingres_close')) {
    /**
...
if (! function_exists('\\Safe\\ingres_commit')) {
    /**
...
if (! function_exists('\\Safe\\ingres_connect')) {
    /**
...
if (! function_exists('\\Safe\\ingres_execute')) {
    /**
...
if (! function_exists('\\Safe\\ingres_field_name')) {
    /**
...
if (! function_exists('\\Safe\\ingres_field_type')) {
    /**
...
if (! function_exists('\\Safe\\ingres_free_result')) {
    /**
     *
     *
     * @param resource $result The query result identifier
...
if (! function_exists('\\Safe\\ingres_pconnect')) {
    /**
...
if (! function_exists('\\Safe\\ingres_result_seek')) {
    /**
...
if (! function_exists('\\Safe\\ingres_rollback')) {
    /**
...
if (! function_exists('\\Safe\\ingres_set_environment')) {
    /**
