...
if (! function_exists('\\Safe\\ldap_add_ext')) {
    /**
...
if (! function_exists('\\Safe\\ldap_bind_ext')) {
    /**
...
if (! function_exists('\\Safe\\ldap_delete_ext')) {
    /**
...
if (! function_exists('\\Safe\\ldap_list')) {
    /**
...
if (! function_exists('\\Safe\\ldap_mod_add_ext')) {
    /**
...
if (! function_exists('\\Safe\\ldap_mod_del_ext')) {
    /**
...
if (! function_exists('\\Safe\\ldap_mod_replace_ext')) {
    /**
...
if (! function_exists('\\Safe\\ldap_read')) {
    /**
     * Performs the search for a specified filter on the
...
if (! function_exists('\\Safe\\ldap_rename_ext')) {
    /**
...
if (! function_exists('\\Safe\\ldap_search')) {
    /**
