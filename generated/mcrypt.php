...
use Safe\Exceptions\McryptException;
...
{
    error_clear_last();
    $safeResult = \mcrypt_create_iv($size, $source);
    if ($safeResult === false) {
        throw McryptException::createFromPhpError();
    }
    return $safeResult;
}
...
function mcrypt_decrypt(string $cipher, string $key, string $data, string $mode, string $iv = null): string
{
    error_clear_last();
    if ($iv !== null) {
        $safeResult = \mcrypt_decrypt($cipher, $key, $data, $mode, $iv);
    } else {
        $safeResult = \mcrypt_decrypt($cipher, $key, $data, $mode);
    }
    if ($safeResult === false) {
        throw McryptException::createFromPhpError();
    }
...
function mcrypt_encrypt(string $cipher, string $key, string $data, string $mode, string $iv = null): string
{
    error_clear_last();
    if ($iv !== null) {
        $safeResult = \mcrypt_encrypt($cipher, $key, $data, $mode, $iv);
    } else {
        $safeResult = \mcrypt_encrypt($cipher, $key, $data, $mode);
    }
    if ($safeResult === false) {
        throw McryptException::createFromPhpError();
    }
...
{
    error_clear_last();
    $safeResult = \mcrypt_generic_deinit($td);
    if ($safeResult === false) {
        throw McryptException::createFromPhpError();
    }
}
...
{
    error_clear_last();
    $safeResult = \mcrypt_module_close($td);
    if ($safeResult === false) {
        throw McryptException::createFromPhpError();
    }
}
...
{
    error_clear_last();
    $safeResult = \mcrypt_module_open($algorithm, $algorithm_directory, $mode, $mode_directory);
    if ($safeResult === false) {
        throw McryptException::createFromPhpError();
    }
    return $safeResult;
