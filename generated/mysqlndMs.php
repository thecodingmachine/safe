...
if (! function_exists('\\Safe\\mysqlnd_ms_dump_servers')) {
    /**
...
if (! function_exists('\\Safe\\mysqlnd_ms_fabric_select_global')) {
    /**
...
if (! function_exists('\\Safe\\mysqlnd_ms_fabric_select_shard')) {
    /**
     * MySQL Fabric related.
     *
...
if (! function_exists('\\Safe\\mysqlnd_ms_get_last_used_connection')) {
    /**
