...
use Safe\Exceptions\RadiusException;
...
{
    error_clear_last();
    $safeResult = \radius_acct_open();
    if ($safeResult === false) {
        throw RadiusException::createFromPhpError();
    }
    return $safeResult;
}
...
{
    error_clear_last();
    $safeResult = \radius_add_server($radius_handle, $hostname, $port, $secret, $timeout, $max_tries);
    if ($safeResult === false) {
        throw RadiusException::createFromPhpError();
    }
}
...
{
    error_clear_last();
    $safeResult = \radius_close($radius_handle);
    if ($safeResult === false) {
        throw RadiusException::createFromPhpError();
    }
}
...
{
    error_clear_last();
    $safeResult = \radius_config($radius_handle, $file);
    if ($safeResult === false) {
        throw RadiusException::createFromPhpError();
    }
}
...
{
    error_clear_last();
    $safeResult = \radius_create_request($radius_handle, $type);
    if ($safeResult === false) {
        throw RadiusException::createFromPhpError();
    }
}
 ...
 *
 * @param resource $radius_handle The RADIUS resource.
 * @param string $mangled The mangled data to demangle
...
{
    error_clear_last();
    $safeResult = \radius_demangle_mppe_key($radius_handle, $mangled);
    if ($safeResult === false) {
        throw RadiusException::createFromPhpError();
    }
    return $safeResult;
...
{
    error_clear_last();
    $safeResult = \radius_demangle($radius_handle, $mangled);
    if ($safeResult === false) {
        throw RadiusException::createFromPhpError();
    }
    return $safeResult;
...
{
    error_clear_last();
    $safeResult = \radius_get_tagged_attr_data($data);
    if ($safeResult === false) {
        throw RadiusException::createFromPhpError();
    }
    return $safeResult;
...
{
    error_clear_last();
    $safeResult = \radius_get_tagged_attr_tag($data);
    if ($safeResult === false) {
        throw RadiusException::createFromPhpError();
    }
    return $safeResult;
...
{
    error_clear_last();
    $safeResult = \radius_get_vendor_attr($data);
    if ($safeResult === false) {
        throw RadiusException::createFromPhpError();
    }
    return $safeResult;
...
function radius_put_addr($radius_handle, int $type, string $addr, int $options = 0, int $tag = null): void
{
    error_clear_last();
    if ($tag !== null) {
        $safeResult = \radius_put_addr($radius_handle, $type, $addr, $options, $tag);
    } else {
        $safeResult = \radius_put_addr($radius_handle, $type, $addr, $options);
    }
    if ($safeResult === false) {
        throw RadiusException::createFromPhpError();
    }
...
function radius_put_attr($radius_handle, int $type, string $value, int $options = 0, int $tag = null): void
{
    error_clear_last();
    if ($tag !== null) {
        $safeResult = \radius_put_attr($radius_handle, $type, $value, $options, $tag);
    } else {
        $safeResult = \radius_put_attr($radius_handle, $type, $value, $options);
    }
    if ($safeResult === false) {
        throw RadiusException::createFromPhpError();
    }
...
function radius_put_int($radius_handle, int $type, int $value, int $options = 0, int $tag = null): void
{
    error_clear_last();
    if ($tag !== null) {
        $safeResult = \radius_put_int($radius_handle, $type, $value, $options, $tag);
    } else {
        $safeResult = \radius_put_int($radius_handle, $type, $value, $options);
    }
    if ($safeResult === false) {
        throw RadiusException::createFromPhpError();
    }
...
function radius_put_string($radius_handle, int $type, string $value, int $options = 0, int $tag = null): void
{
    error_clear_last();
    if ($tag !== null) {
        $safeResult = \radius_put_string($radius_handle, $type, $value, $options, $tag);
    } else {
        $safeResult = \radius_put_string($radius_handle, $type, $value, $options);
    }
    if ($safeResult === false) {
        throw RadiusException::createFromPhpError();
    }
...
{
    error_clear_last();
    $safeResult = \radius_put_vendor_addr($radius_handle, $vendor, $type, $addr);
    if ($safeResult === false) {
        throw RadiusException::createFromPhpError();
    }
}
...
function radius_put_vendor_attr($radius_handle, int $vendor, int $type, string $value, int $options = 0, int $tag = null): void
{
    error_clear_last();
    if ($tag !== null) {
        $safeResult = \radius_put_vendor_attr($radius_handle, $vendor, $type, $value, $options, $tag);
    } else {
        $safeResult = \radius_put_vendor_attr($radius_handle, $vendor, $type, $value, $options);
    }
    if ($safeResult === false) {
        throw RadiusException::createFromPhpError();
    }
...
function radius_put_vendor_int($radius_handle, int $vendor, int $type, int $value, int $options = 0, int $tag = null): void
{
    error_clear_last();
    if ($tag !== null) {
        $safeResult = \radius_put_vendor_int($radius_handle, $vendor, $type, $value, $options, $tag);
    } else {
        $safeResult = \radius_put_vendor_int($radius_handle, $vendor, $type, $value, $options);
    }
    if ($safeResult === false) {
        throw RadiusException::createFromPhpError();
    }
...
function radius_put_vendor_string($radius_handle, int $vendor, int $type, string $value, int $options = 0, int $tag = null): void
{
    error_clear_last();
    if ($tag !== null) {
        $safeResult = \radius_put_vendor_string($radius_handle, $vendor, $type, $value, $options, $tag);
    } else {
        $safeResult = \radius_put_vendor_string($radius_handle, $vendor, $type, $value, $options);
    }
    if ($safeResult === false) {
        throw RadiusException::createFromPhpError();
    }
...
{
    error_clear_last();
    $safeResult = \radius_request_authenticator($radius_handle);
    if ($safeResult === false) {
        throw RadiusException::createFromPhpError();
    }
    return $safeResult;
...
{
    error_clear_last();
    $safeResult = \radius_salt_encrypt_attr($radius_handle, $data);
    if ($safeResult === false) {
        throw RadiusException::createFromPhpError();
    }
    return $safeResult;
...
{
    error_clear_last();
    $safeResult = \radius_server_secret($radius_handle);
    if ($safeResult === false) {
        throw RadiusException::createFromPhpError();
    }
    return $safeResult;
