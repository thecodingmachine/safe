...
{
    error_clear_last();
    $safeResult = \stats_covariance($a, $b);
    if ($safeResult === false) {
...
{
    error_clear_last();
    $safeResult = \stats_standard_deviation($a, $sample);
    if ($safeResult === false) {
        throw StatsException::createFromPhpError();
    }
    return $safeResult;
...
{
    error_clear_last();
    $safeResult = \stats_stat_correlation($arr1, $arr2);
    if ($safeResult === false) {
        throw StatsException::createFromPhpError();
    }
    return $safeResult;
...
{
    error_clear_last();
    $safeResult = \stats_stat_innerproduct($arr1, $arr2);
    if ($safeResult === false) {
        throw StatsException::createFromPhpError();
    }
    return $safeResult;
...
{
    error_clear_last();
    $safeResult = \stats_variance($a, $sample);
    if ($safeResult === false) {
        throw StatsException::createFromPhpError();
    }
    return $safeResult;
