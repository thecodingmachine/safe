...
use Safe\Exceptions\WincacheException;
 ...
 *
 *
 * @throws WincacheException
 *
 */
function wincache_fcache_fileinfo(bool $summaryonly = false): array
{
    error_clear_last();
    $safeResult = \wincache_fcache_fileinfo($summaryonly);
    if ($safeResult === false) {
        throw WincacheException::createFromPhpError();
    }
    return $safeResult;
}
...
{
    error_clear_last();
    $safeResult = \wincache_fcache_meminfo();
    if ($safeResult === false) {
        throw WincacheException::createFromPhpError();
    }
    return $safeResult;
...
{
    error_clear_last();
    $safeResult = \wincache_lock($key, $isglobal);
    if ($safeResult === false) {
        throw WincacheException::createFromPhpError();
    }
}
...
{
    error_clear_last();
    $safeResult = \wincache_ocache_fileinfo($summaryonly);
    if ($safeResult === false) {
        throw WincacheException::createFromPhpError();
    }
    return $safeResult;
...
{
    error_clear_last();
    $safeResult = \wincache_ocache_meminfo();
    if ($safeResult === false) {
        throw WincacheException::createFromPhpError();
    }
    return $safeResult;
...
{
    error_clear_last();
    $safeResult = \wincache_refresh_if_changed($files);
    if ($safeResult === false) {
        throw WincacheException::createFromPhpError();
    }
}
...
{
    error_clear_last();
    $safeResult = \wincache_rplist_fileinfo($summaryonly);
    if ($safeResult === false) {
        throw WincacheException::createFromPhpError();
    }
    return $safeResult;
...
{
    error_clear_last();
    $safeResult = \wincache_rplist_meminfo();
    if ($safeResult === false) {
        throw WincacheException::createFromPhpError();
    }
    return $safeResult;
...
{
    error_clear_last();
    $safeResult = \wincache_scache_info($summaryonly);
    if ($safeResult === false) {
        throw WincacheException::createFromPhpError();
    }
    return $safeResult;
...
{
    error_clear_last();
    $safeResult = \wincache_scache_meminfo();
    if ($safeResult === false) {
        throw WincacheException::createFromPhpError();
    }
    return $safeResult;
...
{
    error_clear_last();
    $safeResult = \wincache_ucache_cas($key, $old_value, $new_value);
    if ($safeResult === false) {
        throw WincacheException::createFromPhpError();
    }
}
...
{
    error_clear_last();
    $safeResult = \wincache_ucache_clear();
    if ($safeResult === false) {
        throw WincacheException::createFromPhpError();
    }
}
 ...
 * key is case sensitive.
 * @param int $dec_by The value by which the variable associated with the key will get decremented.
 ...
 * @param bool|null $success Will be set to TRUE on success and FALSE on failure.
 * @return mixed
 * @throws WincacheException
 *
 */
...
{
    error_clear_last();
    $safeResult = \wincache_ucache_dec($key, $dec_by, $success);
    if ($safeResult === false) {
        throw WincacheException::createFromPhpError();
    }
    return $safeResult;
...
{
    error_clear_last();
    $safeResult = \wincache_ucache_delete($key);
    if ($safeResult === false) {
        throw WincacheException::createFromPhpError();
    }
}
...
{
    error_clear_last();
    $safeResult = \wincache_ucache_get($key, $success);
    if ($safeResult === false) {
        throw WincacheException::createFromPhpError();
    }
    return $safeResult;
 ...
 * @param string $key The key that was used to store the variable in the cache.
 * key is case sensitive.
 * @param int $inc_by The value by which the variable associated with the key will get incremented.
 * If the argument is a floating point number it will be truncated to nearest integer. The variable
 * associated with the key should be of type long, otherwise
 * the function fails and returns FALSE.
 * @param bool|null $success Will be set to TRUE on success and FALSE on failure.
 ...
 *
 */
function wincache_ucache_inc(string $key, int $inc_by = 1, ?bool &$success = null): int
{
    error_clear_last();
    $safeResult = \wincache_ucache_inc($key, $inc_by, $success);
    if ($safeResult === false) {
        throw WincacheException::createFromPhpError();
    }
    return $safeResult;
...
{
    error_clear_last();
    $safeResult = \wincache_ucache_info($summaryonly, $key);
    if ($safeResult === false) {
        throw WincacheException::createFromPhpError();
    }
    return $safeResult;
...
{
    error_clear_last();
    $safeResult = \wincache_ucache_meminfo();
    if ($safeResult === false) {
        throw WincacheException::createFromPhpError();
    }
    return $safeResult;
...
{
    error_clear_last();
    $safeResult = \wincache_unlock($key);
    if ($safeResult === false) {
        throw WincacheException::createFromPhpError();
    }
}
