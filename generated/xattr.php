...
use Safe\Exceptions\XattrException;
...
{
    error_clear_last();
    $safeResult = \xattr_remove($filename, $name, $flags);
    if ($safeResult === false) {
        throw XattrException::createFromPhpError();
    }
}
...
{
    error_clear_last();
    $safeResult = \xattr_set($filename, $name, $value, $flags);
    if ($safeResult === false) {
        throw XattrException::createFromPhpError();
    }
}
