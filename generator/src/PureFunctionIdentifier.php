...
{
    //the list of core impure function, taken from psalm: https://github.com/vimeo/psalm/blob/master/src/Psalm/Internal/Codebase/Functions.php#L280
    //TODO: find a moer dynamic way to get this list?
    private const IMPURE_LIST = [
        // file io
    ...
    public static function isPure(string $functionName): bool
    {
        return \in_array(strtolower($functionName), self::IMPURE_LIST, true);
    }
}
