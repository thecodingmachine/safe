...
final class GeneratedFilesTest extends TestCase
{
    public function testRequireModules(): void
    {
        ...
        $files = \glob(\Safe\FileCreator::getSafeRootDir() . '/generated/*.php');
        if ($files === false) {
    ...
    public function testRequireExceptions(): void
    {
        ...
        $files = \glob(\Safe\FileCreator::getSafeRootDir() . '/generated/Exceptions/*.php');
        if ($files === false) {
    ...
    public function testRequireExceptionInterface(): void
    {
        ...
        require_once \Safe\FileCreator::getSafeRootDir() . '/lib/Exceptions/SafeExceptionInterface.php';
    }
